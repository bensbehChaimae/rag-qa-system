...
class PGVectorProvider(VectorDBInterface):
    ...
    # By collection here we mean table !
    ...
    async def delete_collection(self, collection_name: str):
        async with self.db_client() as session:
            async with session.begin():
                ...
                await session.commit()    # Add commit when only modifying data 
    ...
    # With mzny data you might need to create new indexes are remove old one : 
